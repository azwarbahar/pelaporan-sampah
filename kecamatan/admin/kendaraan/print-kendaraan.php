<?php
require '../../../koneksi.php';
$masyarakat = mysqli_query($conn, "SELECT * FROM tb_kendaraan");
?>
  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-12 invoice-col">
        <br><br>
        <h4 style="text-align: center;">DATA KENDARAAN SAMPAH KECAMATAN TAMALATE</h4>
        <br>
      </div><br>
      <!-- /.col -->
        ...
        <table class="table table-bordered table-striped" >
          ...
          <?php
                   $i = 1; foreach($masyarakat as $dta) {
                    ...
                    <td style="font-size: 15px;"><?= $dta['kelurahan_kendaraan'] ?></td>
