                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                      <div class="text-center">
                        <img class="img-fluid" src="/pelaporan-sampah/kelurahan/admin/masyarakat/foto/<?= $dta['foto_masyarakat'] ?>" style="max-width: 280px; max-height: 350px; min-width: 280px; min-height: 350px;" alt="User profile picture">
                      </div>
                      <br>
