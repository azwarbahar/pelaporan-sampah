              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                  ...
                  <ul class="navbar-nav search-right mt-lg-0 mt-2">
                      ...
                      <li class="nav-item dropdown">
                          <a href="contact.html"
                              class="nav-link dropdown-toggle btn btn-primary d-none d-lg-block btn-style mr-3"
                              data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                Login</a>
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="kelurahan/">Admin Kelurahan</a>
                                <a class="dropdown-item" href="kecamatan/">Admin Kecamatan</a>
                            </div>
                            </li>
                  </ul>
    ...
    <div class="container py-lg-5 py-md-4 py-2">
        <div class="row">
            <div class="col-lg-4 mb-lg-0 mb-5">
                ...
                <h3 class="title-big">Our Best Certified Sanitizing company </h3>
                <p class="pt-4">Aliquam ac est vel nisl init et justo vel ut nibh rhoncusm vel eget
                    enim. Curabitur mattis orci sed leo mattis, nec maximus nibh lorem dolor sit.</p>
        ...
        <div class="container">
            <div class="row main-cont-wthree-2">
                <div class="col-lg-6 feature-grid-left">
                    ...
                    <p class="text-para mt-lg-4 mt-3">Curabitur id gravida risus. Fusce eget ex fermentum, ultricies nisi ac sed,
                        lacinia est.
