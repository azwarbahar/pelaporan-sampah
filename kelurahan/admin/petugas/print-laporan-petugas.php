...
$masyarakat = mysqli_query($conn, "SELECT * FROM tb_laporan_petugas WHERE kelurahan = '$kelurahan_header' ORDER BY id_laporan_petugas DESC");
?>
  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-12 invoice-col">
        <br><br>
        <h4 style="text-align: center;">Daftar Laporan Harian Petugas Kebersihan Kelurahan <?= $kelurahan_header ?></h4>
        <br>
      </div><br>
      <!-- /.col -->
