...
$masyarakat = mysqli_query($conn, "SELECT * FROM tb_pekerja WHERE kelurahan_pekerja = '$kelurahan_header'");
?>
  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-12 invoice-col">
        <br><br>
        <h4 style="text-align: center;">Daftar Nama Petugas Kebersihan Kelurahan <?= $kelurahan_header ?></h4>
        <br>
      </div><br>
      <!-- /.col -->
      ...
      <div class="col-12 table-responsive">
        <table class="table table-bordered table-striped" >
          ...
          <tr>
            ...
            <th style="text-align: center; font-size: 15px;">Jabatan</th>
          </tr>
          </thead>
          <tbody>
          ...
          <?php
                   $i = 1; foreach($masyarakat as $dta) {
                    ...
                    <td style="font-size: 15px;"><?= $dta['nama_pekerja'] ?></td>
                    <td style="font-size: 15px;"><?= $dta['kelurahan_pekerja'] ?></td>
                    <td style="font-size: 15px;"><?= $dta['telpon_pekerja'] ?></td>
                    <td style="font-size: 15px;"><?= $dta['role_pekerja'] ?></td>
                  </tr>
                  <?php
                  $i = $i + 1; }
                  ?>
