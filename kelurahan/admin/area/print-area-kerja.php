...
$masyarakat = mysqli_query($conn, "SELECT * FROM tb_area WHERE kelurahan_area = '$kelurahan_header'");
?>
  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-12 invoice-col">
        <br><br>
        <h4 style="text-align: center;">Daftar Area Kerja Kelurahan <?= $kelurahan_header ?></h4>
        <br>
      </div><br>
      <!-- /.col -->
      ...
      <div class="col-12 table-responsive">
        <table class="table table-bordered table-striped" >
          ...
          <tr>
            ...
            <th style="text-align: center; font-size: 15px;">Nama Area</th>
          </tr>
          </thead>
          <tbody>
          ...
          <?php
                   $i = 1; foreach($masyarakat as $dta) {
                    ...
                    <td style="font-size: 15px;"><?= $dta['nama_area'] ?></td>
                  </tr>
                  <?php
                  $i = $i + 1; }
                  ?>
