...
if (isset($_COOKIE['get_id_kelurahan'])) $_SESSION['get_id_kelurahan'] = $_COOKIE['get_id_kelurahan'];

if (isset($_SESSION['login_admin_kelurahan'])) header("location: admin/");
...
if (isset($_POST['login'])) {
  ...
  $result = mysqli_query($conn, "SELECT * FROM tb_akun_kelurahan WHERE username_akun_kelurahan = '$username' AND status_akun_kelurahan = 'Aktif'");
    ...
    if (password_verify($password, $get_password)) {
      ...
      setcookie('get_id_kelurahan', $get_id_kelurahan, time()+172800);
        ...
        if ($status != 'Aktif') $err_stss = true;
          ...
          $_SESSION['login_admin_kelurahan'] = $get_password;
          if (isset($_POST['remember'])) {
            setcookie('login_admin_kelurahan', $get_password, time()+172800);
          }
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Login Kelurahan</p>
      <br>
